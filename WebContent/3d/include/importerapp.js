...
ImporterApp.prototype.Init = function ()
{
	...
	var match = window.matchMedia ('(max-device-width : 900px)');
...
ImporterApp.prototype.ProcessFiles = function (fileList, isUrl)
{
	...
	var myJSON = JSON.stringify(userFiles);
	

	//processorFunc = JSM.ConvertObjToJsonData;
	//userFiles = 'C:\Users\SLTDev1\Desktop\object\look_diamond.obj';
