		...
		<table cellpadding="0" cellspacing="0">
			<tr class="">
				<td colspan="2" align="right"><b>VAT : <%=c.getVat_number()%></b>
					<br> Date: <%=simpleDateFormat.format(challanBean.getInsert_date())%></td>
			</tr>


			<tr class="information">
				<td colspan="2" align="center">Work Order No. <font color="red" style="font-weight: bold;"><%=challanBean.getChallan_number()%></font>
				</td>
			</tr>

			<tr class="">
				<td colspan="2" align="left"><b>To:</b> <br>
				<font style="font-weight: bold;"><%=challanBean.getCustomerBean().getCompany()%></font>&nbsp;&nbsp;&nbsp;<font
					style="font-weight: bold;">VAT NO: <%=challanBean.getCustomerBean().getVat_number()%></font>
				</td>
			</tr>
			<tr class="">
				<td colspan="2" align="left" style="white-space: pre-wrap;"><%=challanBean.getCustomerBean().getAddress()%><br><%=challanBean.getCustomerBean().getCity()%>,<%=challanBean.getCustomerBean().getState()%> <%=challanBean.getCustomerBean().getCountry()%></td>
			</tr>
		...
		<table class="listTable">
			...
			%>
				<tr bgcolor="" align="center">
					...
					<%-- <td><%=clb.getPer_carat_rate()%> $</td>
					<td><%=String.format("%.2f", clb.getFinal_rate())%> $</td> --%>
				</tr>
			<%} %>
		
			<tr>
				<th colspan="3" align="right">Total</th>
				<th align="center"><%=listOfChallanLine.size()%></th>
