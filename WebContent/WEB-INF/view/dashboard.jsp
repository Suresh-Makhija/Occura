...
<%--                 <a href="index.html"><img src="<%=request.getContextPath()%>/assets/images/logo.svg" alt="Occura Logo" class="img-responsive logo"></a>                 --%>
            </div>
...
function loadChartIncomeAndExpense()
{
	}
	...
	loadCalculatedData();
	loadChartIncomeAndExpense();
	function loadCalculatedData(){
