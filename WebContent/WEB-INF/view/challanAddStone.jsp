...
<%
	...
	int custId = cc.getCustomerBean().getCustomer_id();
	String kapan = "0";
	String lot = "0";
		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12">
					<h2 class="content-header-title mb-0"><i class="icon-ios-list"></i> Add Challan Line</h2>
					<div class="row breadcrumbs-top">
		              <div class="breadcrumb-wrapper col-xs-12">
		                <ol class="breadcrumb">
		                  ...
		                  <li class="breadcrumb-item active">Add Challan Line in challan Number : <%=cc.getChallan_number()%></li>
		                </ol>
		              </div>
          	 	 </div>
				</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<div class="col-md-6">
									<h4 class="card-title" id="striped-label-layout-icons">Add Stone in Challan Number : <%=cc.getChallan_number()%></h4>
								</div>
							...
							<div class="card-body collapse in">
								...
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
										<form action="javascript:;" method="post" id="formSave">
										
										<input type="hidden" name="custId" value="<%=custId%>">
										<input type="hidden" name="userId" value="<%=user_id%>">
										<input type="hidden" name="userCustId" value="<%=userCustId%>">
										<input type="hidden" name="challanId" value="<%=decodeCid%>">
													<div class="row">
														<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">	
															<div class="form-group">
																<label for="userinput1">Customer</label> 
																
																<input type="hidden" name="custId" id="custId" value="<%=cc.getCustomerBean().getCustomer_id()%>">
																<input type="text" class="form-control" value="<%=cc.getCustomerBean().getFullname()%> (<%=cc.getCustomerBean().getCompany()%>)" readonly="readonly">
...
$("#saveLoader").hide();
    function setStone(){
    	...
    	window.location.href = "redirect?p=Y2hhbGxhbkFkZFN0b25l=&cId=<%=encodeCid%>&custId="+custId+"&kapan="+kapan+"&lot="+lot;
    }
