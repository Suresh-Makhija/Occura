...
%>
<title><%=invoiceBean.getInvoice_num()%>_SLTL</title>
<style>
 .invoice-box {
        max-width: 800px;
        margin: auto;
	...
	<tr>
		...
		<tr>
			...
			<td align="left" style="width: 40%">
				<b>From,</b>	<br>
				<b> Sahajanand Laser Technology Ltd. </b><br>
				<font style="white-space:pre-wrap;">E-30, Electorincs Estate, G.I.D.C, Sector - 26 Gandhinagar</font><br>
			 ...
			 <%
				...
				for(String kapan : listOfKapan){ 
					...
					for(String lot : listOfKapanLot){ 
						...
						for(Double rate : listOfrateBYkapanLot){
							
							//List<InvoiceLineBean> listOfInvoiceLine = allListDAO.listOfInvoiceLineKapanLot(decodeIid, kapan, lot,rate);
							
							List<Object[]> listOfInvoiceLine = allListDAO.listOfInvoiceLineByRateKapnaLot(decodeIid, rate,kapan,lot);
							
							totalQty = totalQty + listOfInvoiceLine.size();
							double amount = rate * listOfInvoiceLine.size();
				%>
			<tr align="center">
				...
				<td style="padding: 3px;"><%=String.format("%.2f", rate)%></td>
		...
		<table style="padding-top: 15px;">
			<tr>
				<td align="right">
					For, Sahajanand laser Technology Ltd
					<br><br>
