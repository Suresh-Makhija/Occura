...
<%
	...
	if(request.getParameter("stone_name") != null){
		stone = request.getParameter("stoneName");
	}
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								...
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
										<form action="stockHistoryForUser" method="post">
													...
													<div class="row">
														...
														<div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">	
															...
															<div class="form-group">
																...
																<input type="text" name="stoneName" value="<%=stone%>" class="form-control" placeholder="Enter Stone Name">
															</div>
														</div>
														<div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">	
															<fieldset>
...
function setStone(){
	...
	window.location.href = "redirect?p=dXNlclNpZGVTdG9ja0hpc3Rvcnk=&custId="+custId+"&kapan="+kapan+"&lot="+lot;
}
