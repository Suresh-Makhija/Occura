...
//t.rotationx = 0.2; t.rotationy = 0.04; t.rotationz = 9.38;
//alert(t.rotationy);
	console.log(t)
    var o = this;
    this.error = null, this.options = t, this.parent_element = e, this.get_opt = function(e, t) {
        ...
        var t = new Worker(("string" == typeof o.load_three_files ? o.load_three_files : "") + "stl/load_stl.min.js");
        ...
        t && (delete o.models[o.models_ref[e]], delete o.models_ref[e], o.loaded_models_arr.splice(e, 1), o.models_count = Object.keys(o.models).length, o.scene.remove(t.mesh))
        ...
        null != e && ("transparent" != t ? (e.traverse(function(e) {
            e.visible = !0
        }), e.material.color.set(parseInt(t.substr(1), 16)), e.material.needsUpdate = !0) : e.traverse(function(e) {
            e.visible = !1
        }))
        ...
        }!1 === o.mouse_zoom && o.set_mouse_zoom(o.mouse_zoom), o.animate(), o.models_to_add && o.add_models(o.models_to_add), o.set_auto_resize(o.auto_resize)
        ...
        "string" != typeof o.load_three_files && (o.load_three_files = ""), o.scripts_loader = new ScriptsLoader, o.scripts_loader.load_scripts(new Array(e + "stl/three.min.js", e + "stl/webgl_detector.js", e + "stl/Projector.js", e + "stl/CanvasRenderer.js", e + (0 == o.controls_type ? "stl/OrbitControls.js" : "TrackballControls.js")), o.external_files_loaded)
