...
<!--                                <button  type="button" class="fa fa-camera">Start Streaming</button> -->
                                    ...
                                    <div class="container">
                                        ...
                                        <%--  <%if (records.length >0){ %>
                                          ...
                                          <% }) } else { %> --%>
                                           <div  id="snapshot" >
<!--                                            onclick=openfile();  -->
<%--                                             <img src="<%=request.getContextPath()%>/images/user1.png" class="profile" id="profileid" alt="image"><br><br> --%>
                                           </div>
