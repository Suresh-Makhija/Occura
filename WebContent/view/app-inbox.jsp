...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hospital/light/app-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 May 2021 10:08:29 GMT -->
<head>
<title>:: Lucid Hospital :: Inbox</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane active" id="menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="app-inbox.html"><i class="icon-home"></i>Inbox App</a></li>
...
<script>
     $(".mobile-left .email-left").on('click', function(){
        $(".mail-inbox .mail-left").toggleClass('open');
    });
...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hospital/light/app-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 May 2021 10:08:30 GMT -->
</html>