...
function setupqr(){
//    window.scrollTo(0,1)
 /*    wd = window.innerWidth-800;
    ht = window.innerHeight-600;
    ...
    qrc.canvas.width = wd-50;
    qrc.canvas.height = ht-33;
    qrc.fillStyle = 'white';
...
function doqr() {
   ...
   /* var clientName = d.qrinp.clientName.value;
    var kapanName = d.qrinp.kapanName.value;
    var lotName = d.qrinp.lotName.value;
    var stoneName = d.qrinp.stoneName.value;
    var date = d.qrinp.date.value;*/
    
    
    var str = clientName+'##'+kapanName+"##"+lotName+"##"+stoneName+"##"+weight+"##"+date;
    qf = genframe(str);
    qrc.lineWidth=1;
