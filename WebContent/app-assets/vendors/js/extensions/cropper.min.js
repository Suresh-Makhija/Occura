/*! * Cropper v2.3.3 * https://github.com/fengyuanchen/cropper * * Copyright (c) 2014-2016 Fengyuan Chen and contributors * Released under the MIT license * * Date: 2016-08-10T08:58:55.176Z */
 !function(t){
...
(function(t){
    ...
    function u(t){
        ...
        if(255===l.getUint8(0)&&216===l.getUint8(1))for(p=2;
        p<d;
        ){
        ...
        if(n&&(e=n+4,s=n+10,"Exif"===g(l,e,4)&&(h=l.getUint16(s),o=18761===h,(o||19789===h)&&42===l.getUint16(s+2,o)&&(a=l.getUint32(s+4,o),a>=8&&(r=s+a)))),r)for(d=l.getUint16(r,o),c=0;
        c<d;
        c++)if(p=r+12*c+2,274===l.getUint16(p,o)){
    ...
    v.prototype={
        ...
        ,load:function(i){
            ...
            if(i&&(n.one(A,a.build),!this.trigger(A).isDefaultPrevented())){
                if(this.url=i,this.image={
                }
                ,!a.checkOrientation||!B)return this.clone();
        ...
        ,start:function(){
            ...
            this.isImg||(e.off(F,this.stop),i=e),r(i[0],t.proxy(function(i,e){
                t.extend(this.image,{
                    naturalWidth:i,naturalHeight:e,aspectRatio:i/e
                }
        ...
        ,initContainer:function(){
            ...
            s.addClass(T),i.removeClass(T),s.css(this.container={
                width:xt(e.width(),vt(t.minContainerWidth)||200),height:xt(e.height(),vt(t.minContainerHeight)||100)
            }
        ...
        ,initCanvas:function(){
            ...
            o*d>a?3===e?g=o*d:u=a/d:3===e?u=a/d:g=o*d,i={
                naturalWidth:c,naturalHeight:l,aspectRatio:d,width:g,height:u
            }
            ,i.oldLeft=i.left=(a-g)/2,i.oldTop=i.top=(o-u)/2,this.canvas=i,this.isLimited=1===e||2===e,this.limitCanvas(!0,!0),this.initialImage=t.extend({
            }
            ,h),this.initialCanvas=t.extend({
            }
            ,i)
        }
        ...
        ,renderCanvas:function(t){
            ...
            this.isRotated&&(this.isRotated=!1,e=c({
                width:a.width,height:a.height,degree:o
            }
        ...
        ,renderImage:function(i){
            ...
            a.rotate&&(e=c({
                width:s.width,height:s.height,degree:a.rotate,aspectRatio:a.aspectRatio
            }
            ,!0)),t.extend(a,e?{
                width:e.width,height:e.height,left:(s.width-e.width)/2,top:(s.height-e.height)/2
            }
            :{
                width:s.width,height:s.height,left:0,top:0
            }
            ),this.$clone.css({
                width:a.width,height:a.height,marginLeft:a.left,marginTop:a.top,transform:p(a)
            }
            ),i&&this.output()
        }
        ,initCropBox:function(){
            ...
            ;
            s&&(e.height*s>e.width?o.height=o.width/s:o.width=o.height*s),this.cropBox=o,this.limitCropBox(!0,!0),o.width=wt(xt(o.width,o.minWidth),o.maxWidth),o.height=wt(xt(o.height,o.minHeight),o.maxHeight),o.width=xt(o.minWidth,o.width*a),o.height=xt(o.minHeight,o.height*a),o.oldLeft=o.left=e.left+(e.width-o.width)/2,o.oldTop=o.top=e.top+(e.height-o.height)/2,this.initialCropBox=t.extend({
            }
            ,o)
        }
        ...
        ,renderCropBox:function(){
            ...
            (a.width>a.maxWidth||a.width<a.minWidth)&&(a.left=a.oldLeft),(a.height>a.maxHeight||a.height<a.minHeight)&&(a.top=a.oldTop),a.width=wt(xt(a.width,a.minWidth),a.maxWidth),a.height=wt(xt(a.height,a.minHeight),a.maxHeight),this.limitCropBox(!1,!0),a.oldLeft=a.left=wt(xt(a.left,a.minLeft),a.maxLeft),a.oldTop=a.top=wt(xt(a.top,a.minTop),a.maxTop),t.movable&&t.cropBoxMovable&&this.$face.data(it,a.width===e&&a.height===s?dt:ct),this.$cropBox.css({
                width:a.width,height:a.height,left:a.left,top:a.top
            }
        ...
        ,initPreview:function(){
            ...
            this.$preview=t(this.options.preview),this.$clone2=i=t("<img"+e+' src="'+s+'">'),this.$viewBox.html(i),this.$preview.each(function(){
                var i=t(this);
                i.data(tt,{
                    width:i.width(),height:i.height(),html:i.html()
                }
                ),i.html("<img"+e+' src="'+s+'" style="display:block;
                width:100%;
                height:auto;
        ...
        ,preview:function(){
            ...
            this.isCropped&&!this.isDisabled&&(this.$clone2.css({
                width:h,height:n,marginLeft:-r,marginTop:-c,transform:p(i)
            }
            ),this.$preview.each(function(){
                ...
                a&&(f=l/a,u=o*f),o&&u>d&&(f=d/o,g=a*f,u=d),e.css({
                    ...
                    width:h*f,height:n*f,marginLeft:-r*f,marginTop:-c*f,transform:p(i)
                }
                )
            }
            ))
        ...
        ,change:function(t,i){
            ...
            switch(!o&&t&&(o=c&&l?c/l:1),this.isLimited&&(m=p.minLeft,v=p.minTop,w=m+wt(n.width,r.left+r.width),x=v+wt(n.height,r.top+r.height)),s={
                x:this.endX-this.startX,y:this.endY-this.startY
            }
            ,o&&(s.X=s.y*o,s.Y=s.x/o),h){
                case ct:d+=s.x,g+=s.y;
                break;
                case et:if(s.x>=0&&(u>=w||o&&(g<=v||f>=x))){
                    C=!1;
                    break
                }
                c+=s.x,o&&(l=c/o,g-=s.Y/2),c<0&&(h=st,c=0);
                break;
                case ot:if(s.y<=0&&(g<=v||o&&(d<=m||u>=w))){
                    C=!1;
                    break
                }
                l-=s.y,g+=s.y,o&&(c=l*o,d+=s.X/2),l<0&&(h=at,l=0);
                break;
                case st:if(s.x<=0&&(d<=m||o&&(g<=v||f>=x))){
                    C=!1;
                    break
                }
                c-=s.x,d+=s.x,o&&(l=c/o,g+=s.Y/2),c<0&&(h=et,c=0);
                break;
                case at:if(s.y>=0&&(f>=x||o&&(d<=m||u>=w))){
                    C=!1;
                    break
                }
                ...
                break;
                case dt:this.move(s.x,s.y),C=!1;
                break;
                case gt:this.zoom(function(t,i,e,s){
        ...
        ,zoomTo:function(t,i){
            ...
            if(t=vt(t),t>=0&&this.isBuilt&&!this.isDisabled&&n.zoomable){
                if(s=l*t,a=g*t,i&&(e=i.originalEvent),this.trigger(Z,{
                    originalEvent:e,oldRatio:p/l,ratio:s/l
                }
                ).isDefaultPrevented())return;
                e?(o=this.$cropper.offset(),h=e.touches?d(e.touches):{
                    pageX:i.pageX||e.pageX||0,pageY:i.pageY||e.pageY||0
                }
        ...
        ,getData:function(i){
            ...
            return this.isBuilt&&this.isCropped?(s={
                x:n.left-h.left,y:n.top-h.top,width:n.width,height:n.height
            }
        ...
        ,getCropBoxData:function(){
            ...
            return this.isBuilt&&this.isCropped&&(t={
                left:i.left,top:i.top,width:i.width,height:i.height
            }
            ),t||{
            }
        }
        ...
        ,getCroppedCanvas:function(i){
            ...
            if(this.isBuilt&&ft)return this.isCropped?(t.isPlainObject(i)||(i={
            }
            ),g=this.getData(),e=g.width,s=g.height,p=e/s,t.isPlainObject(i)&&(h=i.width,n=i.height,h?(n=h/p,r=h/e):n&&(h=n*p,r=n/s)),a=$t(h||e),o=$t(n||s),c=t("<canvas>")[0],c.width=a,c.height=o,d=c.getContext("2d"),i.fillColor&&(d.fillStyle=i.fillColor,d.fillRect(0,0,a,o)),d.drawImage.apply(d,function(){
    ...
    ,v.TEMPLATE='<div class="cropper-container"><div class="cropper-wrap-box"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div><div class="cropper-crop-box"><span class="cropper-view-box"></span><span class="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></span><span class="cropper-center"></span><span class="cropper-face"></span><span class="cropper-line line-e" data-action="e"></span><span class="cropper-line line-n" data-action="n"></span><span class="cropper-line line-w" data-action="w"></span><span class="cropper-line line-s" data-action="s"></span><span class="cropper-point point-e" data-action="e"></span><span class="cropper-point point-n" data-action="n"></span><span class="cropper-point point-w" data-action="w"></span><span class="cropper-point point-s" data-action="s"></span><span class="cropper-point point-ne" data-action="ne"></span><span class="cropper-point point-nw" data-action="nw"></span><span class="cropper-point point-sw" data-action="sw"></span><span class="cropper-point point-se" data-action="se"></span></div></div>',v.other=t.fn.cropper,t.fn.cropper=function(i){
        ...
        return this.each(function(){
            ...
            if(!n){
                ...
                ,h.data(),t.isPlainObject(i)&&i),h.data(L,n=new v(this,e))
            }
